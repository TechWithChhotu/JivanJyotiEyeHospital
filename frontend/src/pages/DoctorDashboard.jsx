...
//   // 🌟 नया फंक्शन: वर्तमान में केबिन के अंदर मौजूद एक्टिव मरीज को डेटाबेस से लाना
...
//   // कंपोनेंट लोड होते ही करंट स्टेटस और एक्टिव मरीज दोनों फेच करें
//   useEffect(() => {
//     fetchCurrentActivePatient(); // 👈 रिफ्रेश होने पर टोकन गायब नहीं होगा
//     fetchCurrentQueueStatus();
//   }, []);

//   // अगले मरीज को बुलाने का हैंडलर
//   // अगले मरीज को बुलाने का हैंडलर (पूर्णतः सुधारा हुआ)
...
//       // नया मरीज आते ही वेटिंग टाइम दोबारा कैलकुलेट करें
...
//       setCurrentPatient(null);
//     } finally {
//       // 🎯 फिक्स: 'loading.false()' को पूरी तरह हटा दिया गया है
//       setLoading(false);
//     }
//   };
...
//               👨‍⚕️ डॉक्टर कंट्रोल पैनल
//             </h2>
//             <p className="text-xs text-slate-400 mt-0.5">
//               मुख्य केबिन (Main Consultation Room)
//             </p>
//           </div>
//           <div className="bg-blue-950 border border-blue-800 text-blue-300 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider animate-pulse">
//             ● लाइव कतार (Live)
//           </div>
//         </div>
...
//                 अगला टोकन बुलाने के लिए नीचे बटन दबाएं
//               </p>
//             </div>
//           )}
//         </div>
...
//             disabled={loading}
//             className={`w-full sm:w-auto text-white text-xl font-black px-12 py-5 rounded-xl shadow-lg transition transform active:scale-95 duration-200 ${
//               loading
